...
<div class='col-sm-9'><select class='form-control' name='medicamentID'>
<?php
...
<div class='col-sm-9'><select class='form-control' name='physID'>
<?php
...
<div class='col-sm-9'><select class='form-control' name='nurseID'>
<?php
